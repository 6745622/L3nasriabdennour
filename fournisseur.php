       ...
       <div class="navbar">
           <div class="icon">
             <h2 class="logo">ApproDZ</h2>
              ...
              <div class="menu">
              <ul>
                  <li><a class="navbar-link" href="fournisseur.php">Acceuil</a></li>
              ...
              <h3>Bienvenue sur notre interface,</h3></br>
                ...
                cher fournisseur. Nous sommes enchantés de vous accueillir ici,<br>
                 prêts à faciliter et renforcer notre collaboration pour assurer un approvisionnement <br>
                 de qualité et une relation fructueuse. </p>
                 <form action="fournisseur.php" method="post"><div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $numBR = $_POST["numBR"];
    $nomreception = $_POST["nom_reception"];
    $contenureception = $_POST["contenu_reception"];
     
    // Requête d'insertion dans la base de données
    $requete = "INSERT INTO bon_recep(numBR,nom_reception, contenu_reception, envoyeur_id, destinataire_id, date) VALUES ('$numBR','$nomreception', '$contenureception', 'envoyeur_id_value', 'destinataire_id_value', NOW())";
    
    if (mysqli_query($connexion, $requete)) {
        echo "La bon reception a été enregistrée avec succès.";
    } else {
        echo "Erreur lors de l'enregistrement de la  bon reception : " . mysqli_error($connexion);
    }
    // Requête pour récupérer les données de la table bon_reception
...
?>  <br>
              ...
              <label for="numBR">Numero de la bon de reception:</label>
                ...
                <label for="nom_reception">Date:</label>
